  ...
  return (
    <div className="bg-slate-800 text-white  flex flex-col md:flex-row justify-center items-center md:items-start py-12 md:gap-8">
      ...
      <div className="w-full md:w-1/2 p-4 md:p-8">
        <h2 className="text-yellow-400 flex justify-center items-center font-bold text-3xl py-5">About Me</h2>
      ...
      <div className="w-full md:w-1/2 p-4 md:p-8 py-20">
        <h2 className="text-yellow-400 flex justify-center items-center font-bold text-3xl py-5">Education</h2>
